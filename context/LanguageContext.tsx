...
const translations: Translations = {
    ...
    // Seminar
    'seminar.title': { en: 'Speak French, Shine Online', fr: 'Parlez Français, Brillez en Ligne' },
    'seminar.subtitle': { en: 'Register for our upcoming online seminar and join a community of passionate learners.', fr: 'Inscrivez-vous à notre prochain séminaire en ligne et rejoignez une communauté de passionnés.' },
    'seminar.onetime_notice': { en: 'This is a one-time registration form. If you\'ve filled it before, there\'s no need to fill again.', fr: 'Ceci est un formulaire d\'inscription unique. Si vous l\'avez déjà rempli, il n\'est pas nécessaire de recommencer.' },
    'seminar.step1': { en: 'Profile & Status', fr: 'Profil & Statut' },
    'seminar.step2': { en: 'Goals & Community', fr: 'Objectifs & Communauté' },
    'seminar.step1.title': { en: 'Profile Details', fr: 'Détails du Profil' },
    'seminar.step2.title': { en: 'Your French Goals', fr: 'Vos Objectifs en Français' },
    'seminar.label.email': { en: 'Email', fr: 'E-mail' },
    'seminar.label.follow': { en: 'Follow us VASA Consults on LinkedIn & Instagram', fr: 'Suivez VASA Consults sur LinkedIn & Instagram' },
    'seminar.label.filled_before': { en: 'If you ever filled this form, don\'t fill again', fr: 'Si vous avez déjà rempli ce formulaire, ne le remplissez pas à nouveau' },
    'seminar.option.ihave': { en: 'I have', fr: 'Je l\'ai rempli' },
    'seminar.option.ihavenot': { en: 'I have not', fr: 'Je ne l\'ai pas rempli' },
    'seminar.label.describe': { en: 'Which of them best describes you', fr: 'Lequel de ces choix vous décrit le mieux' },
    'seminar.option.student': { en: 'Student', fr: 'Étudiant(e)' },
    'seminar.option.professional': { en: 'Professional', fr: 'Professionnel(le)' },
    'seminar.option.other': { en: 'Other', fr: 'Autre' },
    'seminar.label.duration': { en: 'How long have you been studying French?', fr: 'Depuis combien de temps étudiez-vous le français ?' },
    'seminar.placeholder.duration': { en: 'e.g. 2 years, beginner...', fr: 'ex: 2 ans, débutant...' },
    'seminar.label.goals': { en: 'What are your goals for joining the seminar?', fr: 'Quels sont vos objectifs en rejoignant le séminaire ?' },
    'seminar.placeholder.goals': { en: 'Your expectations...', fr: 'Vos attentes...' },
    'seminar.label.contact': { en: 'Do you want to be contacted for all the upcoming seminars?', fr: 'Souhaitez-vous être contacté(e) pour tous les prochains séminaires ?' },
    'seminar.label.community': { en: 'Join our Speak French, Shine Online Community', fr: 'Rejoignez notre communauté Speak French, Shine Online' },
    'seminar.label.source': { en: 'How did you hear about the seminar', fr: 'Comment avez-vous entendu parler du séminaire' },
    'seminar.success.title': { en: 'Seminar Registration Received!', fr: 'Inscription au Séminaire Reçue !' },
    'seminar.success.desc': { en: 'Thank you for registering. We look forward to seeing you shine online.', fr: 'Merci pour votre inscription. Nous avons hâte de vous voir briller en ligne.' },
